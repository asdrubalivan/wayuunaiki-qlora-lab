...
Si no estás seguro, produce la mejor traducción posible sin inventar notas.
"""
...
def build_prompt(tokenizer, source: str) -> str:
    messages = [
        ...
        {
            "role": "user",
            "content": f"Traduce al wayuunaiki.\n\nEspañol: {source}\nWayuunaiki:",
        },
    ]
...
def main() -> None:
    ...
    parser.add_argument("--out", default="outputs/baseline_qwen25_15b.jsonl")
